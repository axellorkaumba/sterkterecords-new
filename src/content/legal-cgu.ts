    ...
    sections: [
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            [
              "Plan",
              "Le niveau d'abonnement souscrit par l'Artiste (Solo, ou Label pour les artistes signés — voir Article 5.2).",
            ],
          ],
        },
      },
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "5.2 Nos offres",
          "Sterkte Records applique un modèle forfaitaire : quelle que soit l'offre choisie, tu conserves 100 % de tes royalties nettes (Article 8). Notre rémunération ne provient jamais d'un prélèvement sur tes revenus DSP, mais de l'abonnement lui-même, des options additionnelles (Article 5.3 des présentes, ex. Artwork Apple Music) et de nos prestations annexes (studio, booking, consulting).",
        ],
        table: {
          headers: ["Offre", "Prix", "Royalties artiste", "Sorties"],
          rows: [
            ["Solo — mensuel", "2,49 €/mois", "100 % des revenus nets", "Illimitées"],
            ["Solo — annuel", "19,99 €/an", "100 % des revenus nets", "Illimitées"],
            [
              "Afrique — tarif régional",
              "≈ 9,99 $/an (pays éligibles, facturation annuelle)",
              "100 % des revenus nets",
              "Illimitées",
            ],
            [
              "Label (artistes signés)",
              "Sur devis — non accessible en libre-service",
              "Répartition définie par le contrat individuel",
              "Illimitées",
            ],
          ],
        },
      ...
      },
      {
        ...
        paragraphs: [
          "8.1 Calcul des revenus — 100 % des Revenus Nets te reviennent",
          "Sterkte Records ne prélève aucune commission sur tes revenus DSP, quelle que soit ton offre (Article 5.2). Les seules déductions appliquées sont les Frais Techniques (commissions de notre agrégateur technique et/ou des DSP eux-mêmes) — jamais une commission Sterkte Records.",
        ],
        table: {
          ...
          rows: [
            ...
            ["= Revenus Nets", "95,00 €"],
            ["Part versée à l'artiste (100 % des Revenus Nets)", "95,00 €"],
          ],
        },
      },
      {
        ...
        paragraphs: [
          "Les revenus issus de la monétisation UGC (YouTube Content ID, TikTok, Instagram/Meta) sont soumis à des frais spécifiques prélevés par les plateformes (généralement 20%). Après déduction de ces frais, 100 % du solde net te revient — selon le même principe que les revenus DSP standard.",
        ],
      },
      {
        ...
        paragraphs: [
          ...
          "• Les Revenus Nets — intégralement les tiens",
      ...
      },
      {
        ...
        paragraphs: [
          "9.1 Abonnement Solo",
          "• L'abonnement Solo est facturé d'avance, au choix mensuellement ou annuellement, en euros — ou annuellement en dollars US pour le tarif régional Afrique (pays éligibles, Article 5.2).",
          "• Le paiement est effectué par carte bancaire (rail international) ou Mobile Money (Airtel Money, Orange Money, M-Pesa, MTN — rail Afrique), selon le pays associé à ton compte.",
          "• Aucun remboursement n'est accordé pour une période entamée, sauf en cas de faute exclusive de Sterkte Records.",
          "• Le forfait Label ne fait pas l'objet d'une facturation en libre-service : ses conditions financières sont définies par le contrat individuel signé avec Sterkte Records.",
          ...
          "• Un seuil minimum de versement de 100 USD (ou équivalent) s'applique. En deçà de ce seuil, le solde est reporté sur la période suivante.",
      ...
      {
        heading: "16. Ce qui se passe si ton abonnement expire",
        paragraphs: [
          ...
          "• Si ton abonnement Solo expire (échec de paiement ou résiliation), l'accès à ton tableau de bord (nouvelles soumissions, modifications de sorties, statistiques détaillées) est suspendu jusqu'au renouvellement.",
          "• Tes sorties déjà distribuées restent en ligne sur les DSP et continuent de générer des royalties normalement — aucun retrait immédiat.",
          "• Tu disposes de 90 jours à compter de l'expiration pour renouveler ton abonnement avant tout retrait de tes sorties.",
          "• Tes royalties continuent de s'accumuler pendant cette période et te sont versées normalement (Article 9.2), qu'il y ait ou non renouvellement.",
          "Au-delà de 90 jours sans renouvellement, Sterkte Records peut engager le retrait de tes sorties des DSP (Article 14) — tu en seras notifié(e) au préalable par email.",
    ...
    sections: [
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            [
              "Plan",
              "The subscription tier chosen by the Artist (Solo, or Label for signed artists — see Article 5.2).",
            ],
          ],
        },
      },
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "5.2 Our plans",
          "Sterkte Records uses a flat-fee model: whichever plan you choose, you keep 100% of your net royalties (Article 8). Our revenue never comes from a cut of your DSP earnings — it comes from the subscription itself, optional add-ons (Article 5.3 below, e.g. Apple Music Artwork), and our other services (studio, booking, consulting).",
        ],
        table: {
          headers: ["Plan", "Price", "Artist royalties", "Releases"],
          rows: [
            ["Solo — monthly", "€2.49/month", "100% of net revenue", "Unlimited"],
            ["Solo — annual", "€19.99/year", "100% of net revenue", "Unlimited"],
            [
              "Africa — regional pricing",
              "≈ $9.99/year (eligible countries, billed annually)",
              "100% of net revenue",
              "Unlimited",
            ],
            [
              "Label (signed artists)",
              "Custom quote — not self-service",
              "Split defined by individual contract",
              "Unlimited",
            ],
          ],
        },
      ...
      },
      {
        ...
        paragraphs: [
          "8.1 Revenue calculation — 100% of Net Revenue is yours",
          "Sterkte Records takes no commission on your DSP revenue, regardless of your plan (Article 5.2). The only deductions applied are Technical Fees (our technical aggregator's and/or the DSPs' own commissions) — never a Sterkte Records cut.",
        ],
        table: {
          ...
          rows: [
            ...
            ["= Net Revenue", "€95.00"],
            ["Amount paid to the artist (100% of Net Revenue)", "€95.00"],
          ],
        },
      },
      {
        ...
        paragraphs: [
          "Revenue from UGC monetization (YouTube Content ID, TikTok, Instagram/Meta) is subject to specific fees charged by those platforms (generally 20%). After deducting these fees, 100% of the net balance is yours — same principle as standard DSP revenue.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "9.1 Solo subscription",
          "• The Solo subscription is billed in advance, either monthly or annually at your choice, in euros — or annually in US dollars for the Africa regional pricing (eligible countries, Article 5.2).",
          "• Payment is made by credit card (international rail) or Mobile Money (Airtel Money, Orange Money, M-Pesa, MTN — Africa rail), depending on the country associated with your account.",
          "• No refund is granted for a period already started, except in case of fault exclusively attributable to Sterkte Records.",
          "• The Label plan is not billed through self-service: its financial terms are set out in the individual agreement signed with Sterkte Records.",
          "9.2 Royalty payout",
          "• Royalties are paid out quarterly, within 30 days following the end of each quarter.",
          "• A minimum payout threshold of $100 (or equivalent) applies. Below this threshold, the balance is carried over to the next period.",
      ...
      {
        heading: "16. What happens if your subscription expires",
        paragraphs: [
          ...
          "• If your Solo subscription expires (failed payment or cancellation), access to your dashboard (new submissions, release edits, detailed statistics) is suspended until renewal.",
          "• Releases already distributed stay live on DSPs and keep earning royalties normally — no immediate takedown.",
          "• You have 90 days from expiration to renew your subscription before any takedown of your releases.",
          "• Your royalties keep accruing during this period and are paid out normally (Article 9.2), whether or not you renew.",
          "After 90 days without renewal, Sterkte Records may proceed to take down your releases from DSPs (Article 14) — you will be notified by email beforehand.",
