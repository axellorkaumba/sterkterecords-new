...
/**
 * ATTENTION : `npx shadcn add <composant qui dépend de card>` (ex. `chart`)
 * écrase ce fichier avec la version registry par défaut. Après tout
 * `shadcn add`, vérifier que `shadow-card`/`rounded-lg` sont toujours là.
 */
function Card({
  className,
  size = "default",
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        // Cartes = rayon `lg` + ombre `shadow-card` (§9.3 du CDC), pas un ring générique.
